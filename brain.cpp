...
void Brain::calculateAverage(){
	averageData = eggPower[0] + eggPower[1] + eggPower[2] + eggPower[3] + eggPower[4] + eggPower[5] + eggPower[6] + eggPower[7] / 8;
}

uint32_t Brain::readAverage(){
	return averageData;
}
